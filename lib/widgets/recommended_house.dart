...
class RecommendedHouse extends StatelessWidget {
  ...
  RecommendedHouse({Key? key, Function? handleNavigateToDetails})
      : super(key: key);

  handleNavigateToDetails(BuildContext context, House house) {
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) => GestureDetector(
            onTap: () =>
                handleNavigateToDetails(context, recommendedList[index]),
            child: Container(
              height: 300,
              width: 230,
